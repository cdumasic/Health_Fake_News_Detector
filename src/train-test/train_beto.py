...
# Se añaden las rutas del modelo (BETO) y las rutas de los resultados y el modelo entrenado
MODEL_NAME = "dccuchile/bert-base-spanish-wwm-cased"
OUTPUT_DIR = "./resultados/beto-fakenews-baseline-results"
MODEL_SAVE_DIR = "./modelos/beto-fakenews-baseline-model"
...
print("\nResultados finales de las métricas con BETO baseline:")
