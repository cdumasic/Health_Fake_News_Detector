...
TRAIN_VAL_PATH = "./data/Texto_final/train_baseline.json"
TEST_PATH = "./data/Texto_final/test_baseline.json"

# Se añaden las rutas del modelo (ALBETO) y las rutas de los resultados y el modelo entrenado
MODEL_NAME = "dccuchile/albert-base-spanish"
OUTPUT_DIR = "./resultados/albeto-fakenews-baseline-results"
MODEL_SAVE_DIR = "./modelos/albeto-fakenews-baseline-model"
...
print("\nResultados finales de las métricas con ALBETO baseline:")
