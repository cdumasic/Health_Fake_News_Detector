...
OUTPUT_DIR = "./resultados/beto-fakenews-augmented-results"
MODEL_SAVE_DIR = "./modelos/beto-fakenews-augmented-model"
...
print("\nResultados finales de las métricas con BETO aumentados:")
